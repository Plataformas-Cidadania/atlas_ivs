<?php
 /* =================== Bloqueia o acesso direto pela url =================== */
    ...
    {  
        ...
        $sql = "select var.id, var.sigla, lg.nomecurto, lg.nomelongo from variavel var inner join lang_var lg on var.id = lg.fk_variavel where lg.lang = '" . $user_lang . "' AND var.exibir_na_consulta = true ";
